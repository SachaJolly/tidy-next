...
## 2. Component Creation & Code Reusability (CRITICAL)
...
- **Environment Mocking:** If a component relies on Next.js specific features (like `useRouter`, `usePathname`, or Next/Image) or API calls, you MUST implement the necessary mocks or decorators within the story so it renders perfectly in isolation without crashing.
